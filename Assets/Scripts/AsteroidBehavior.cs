...
public class AsteroidBehavior : MonoBehaviour
{
    ...
    public void Explode()
    {
        ...
        {
            Instantiate(destructions[0], transform.position, transform.rotation);   //...instance the first particle effect in destructions
        
        //...the second image in images
        }else if(image.sprite == images[1])
        {
            Instantiate(destructions[1], transform.position, transform.rotation);   //...instance the second particle effect in destructions

        //...the third image in images
        }else if(image.sprite == images[2])
        {
            Instantiate(destructions[2], transform.position, transform.rotation);   //...instance the third particle effect in destructions
        }
